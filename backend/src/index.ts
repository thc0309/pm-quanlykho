...
import { registerPrintRoutes } from "./modules/print.js";
...
registerReportRoutes(app, authStore, accessStore, pool, config.SESSION_SECRET);
registerPrintRoutes(app, authStore, accessStore, pool, config.SESSION_SECRET);
