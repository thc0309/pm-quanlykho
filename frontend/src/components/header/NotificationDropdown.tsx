  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute -right-[120px] mt-[17px] flex w-[300px] flex-col rounded-2xl border border-gray-200 bg-white p-4 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[340px] lg:right-0"
      >
        ...
        <div role="status" className="py-6 text-center text-sm text-gray-500 dark:text-gray-400">
          Chưa có thông báo.
        </div>
      </Dropdown>
    </div>
